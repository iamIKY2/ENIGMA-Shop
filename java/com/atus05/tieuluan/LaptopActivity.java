...
public class LaptopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Sử dụng FeaturedProductLaptopAdapter cho sản phẩm nổi bật (item_product_laptop_horizontal)
        featuredAdapter = new FeaturedProductLaptopAdapter(this, featuredProducts);
        recyclerViewFeatured.setAdapter(featuredAdapter);

        // Dữ liệu mẫu cho tất cả sản phẩm laptop (có thể giống hoặc khác sản phẩm nổi bật)
        List<Product> allProducts = new ArrayList<>();
        allProducts.addAll(featuredProducts); // Dùng lại dữ liệu mẫu, có thể thêm sản phẩm khác nếu muốn
        // Sử dụng ProductLaptopAdapter cho danh sách sản phẩm laptop (item_product_laptop)
