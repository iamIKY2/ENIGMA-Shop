...
public class ProductManagementActivity extends AppCompatActivity {
    ...
    private void addProduct() {
        ...
        try {
            ...
            Product product = new Product(name, price, oldPrice, rating, sold, R.drawable.iphone_16_pr); // Mặc định icon
    ...
    private void updateProduct() {
        ...
        try {
            ...
            // Tạo đối tượng Product
            Product product = new Product(name, price, oldPrice, rating, sold, R.drawable.iphone_16_pr);
