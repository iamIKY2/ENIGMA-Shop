...
public class MainActivity extends AppCompatActivity implements CategoryAdapter.OnCategoryClickListener {
    ...
    public void onCategoryClick(Category category) {
        ...
        } else if (category.getName().equalsIgnoreCase("Điện thoại")) {
            // Nếu là danh mục Điện thoại thì chuyển sang trang SmatPhone
            Intent intent = new Intent(this, SmatPhone.class);
            startActivity(intent);
        } else {
