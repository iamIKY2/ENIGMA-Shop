...
// Adapter cho danh sách sản phẩm smartphone (dạng dọc)
public class ProductSmatPhoneAdapter extends RecyclerView.Adapter<ProductSmatPhoneAdapter.ProductViewHolder> {
    private List<Product> productList;
    private Context context;

    public ProductSmatPhoneAdapter(Context context, List<Product> productList) {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_product_smatphone, parent, false);
