...
public class SmatPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smatphone); // Dùng lại layout của phone
        ...
        // Dữ liệu mẫu cho hãng điện thoại
        ...
        brandAdapter.setOnItemClickListener(new SimpleStringAdapter.OnItemClickListener() {
            ...
            public void onItemClick(String brand) {
                ...
                Toast.makeText(SmatPhone.this, "Bạn đã chọn hãng: " + brand, Toast.LENGTH_SHORT).show();
            }
        });
        // Dữ liệu mẫu cho nhu cầu điện thoại
        ...
        allProducts.add(featuredProducts.get(featuredProducts.size() - 1));
